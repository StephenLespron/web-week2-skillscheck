...
let me = {
	...
	state: `Arizona`,
	age: 29,
	greeter: (firstName, state) => `Hello! My name is ${firstName} and I live in ${state}`
}
...
let total = myNumbers.reduce((acc, elem) => acc + elem)
...
let enemies = people.filter(elem => !elem.friend)
...
let totallyAwesome = people.reduce((acc, elem) => acc + elem.awesomeLevel, 0)
